...
import (
	...
	"github.com/lightbliss/goapi-server/restapi/operations"
	"github.com/lightbliss/goapi-server/restapi/operations/pet"
)

//go:generate swagger generate server --target ../../goapi-server --name SwaggerPetstore --spec ../../../../../github.com/lightbliss/goapi-server/swagger.json
